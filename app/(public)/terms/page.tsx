  ...
  return (
    <LegalShell title="Terms of Service" updated={UPDATED}>
      ...
      <Section heading="6. Plans, billing & refunds">
        <List
          items={[
            "The Free plan is available at no cost. Pro is billed monthly, annually, or as a one-off lifetime purchase, in AUD, via Stripe.",
            "Subscriptions renew automatically until cancelled; you can cancel any time and keep Pro until the end of the paid period.",
